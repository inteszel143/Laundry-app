        ...
        <View className="bg-white h-full, w-full">
            ...
            <View className="h-full w-full flex justify-around pt-40 pb-10">
                ...
                <View className="flex items-center mx-4 space-y-4">
                    ...
                    <Animated.View entering={FadeInDown.delay(200).duration(1000).springify()} className="bg-black/5 p-5 mb-3 rounded-2xl w-full">
                    ...
                    {/* dont have account */}
                    <Animated.View entering={FadeInDown.delay(600).duration(1000).springify()} className="flex-row justify-center space-x-2">
                        <Text>Don't have an account?</Text>
                        <TouchableOpacity onPress={() => navigation.push('SignUpScreen')}>
                            <Text className="text-sky-600 font-semibold">Sign Up</Text>
                        </TouchableOpacity>
                    </Animated.View>
                </View>
            </View>
